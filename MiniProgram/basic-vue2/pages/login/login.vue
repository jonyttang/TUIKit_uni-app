<template>
	<view class="container">
		...
		<view class="chat-section" v-else>
			...
			<input class="target-input" v-model="targetUserID"
				:style="{ borderColor: targetUserID ? '#07C160' : '#DDDDDD' }" placeholder="输入对方用户ID" />
...
export default {
	...
	methods: {
		...
		startChat() {
			...
			const conversationID = `C2C${this.targetUserID}`;
